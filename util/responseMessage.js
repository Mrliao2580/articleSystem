...
const responseMessage = {
    argsfail: {errcode:10001,messag:"参数有误，检查后请重新尝试"},
    ...
    addfail:{errcode:10005,message:'添加失败，检查后请重新尝试'},
    getsucc: {errcode:0,message:'获取成功'},
    getfail:{errcode:10006,message:'获取失败，检查后请重新尝试'},
    updsucc: {errcode:0,message:'编辑成功'},
    updfail:{errcode:10007,message:'编辑失败，检查后请重新尝试'},
}
